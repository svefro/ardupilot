...
static void read_radio()
{
    ...
    if (hal.rcin->new_input()) {
        ...
        g.rc_5.set_pwm(periods[rcmap.flightmode_5()-1]);
        g.rc_6.set_pwm(periods[rcmap.tune_6()-1]);
        g.rc_7.set_pwm(periods[rcmap.aux1_7()-1]);
        g.rc_8.set_pwm(periods[rcmap.aux2_8()-1]);
